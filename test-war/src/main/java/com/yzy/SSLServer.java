...
public class SSLServer {
    ...
    public void init() {
        try {
            ...
            ks.load(new FileInputStream("D://test//key4//kserver.keystore"), SERVER_KEY_STORE_PASSWORD.toCharArray());
            tks.load(new FileInputStream("D://test//key4//tserver.keystore"), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());
